...
class HelloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                response_deserializer=hello__pb2.HelloMessage.FromString,
                )
...
def add_HelloServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=hello__pb2.HelloMessage.SerializeToString,
            ),
    }
...
class HelloService(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/HelloService/SayHello',
            ...
            hello__pb2.HelloMessage.FromString,
